...
namespace np
{
    namespace util
    {
        ...
        filename_t filename_t::make_absolute_to(filename_t absfile, bool isdir) const
        {
            filename_t abs;
            tok_t tok(c_str(), "/");
            const char *part;
        ...
        filename_t filename_t::make_absolute() const
        {
            return make_absolute_to(filename_t(), false);
        }

        filename_t filename_t::make_absolute_to_file(filename_t absfile) const
        {
            return make_absolute_to(absfile, false);
        }

        filename_t filename_t::make_absolute_to_dir(filename_t absdir) const
        {
        ...
        //
        filename_t filename_t::normalise() const
        {
            string up;
            string down;
            tok_t tok(c_str(), "/");
