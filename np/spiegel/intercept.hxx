    ...
    namespace spiegel
    {
        ...
        struct call_t
        {
          ...
          public:
             ...
             */
            virtual void redirect(addr_t f)
            {
                redirect_ = f;
            }
            /*
             ...
             */
            virtual unsigned long get_retval() const
            {
                return retval_;
            }
            virtual unsigned long get_retval32() const
            {
                return retval_;
            }
            virtual uint64_t get_retval64() const
            {
             ...
             */
            virtual void set_retval(unsigned long rv)
            {
                retval_ = rv;
            }
        };
